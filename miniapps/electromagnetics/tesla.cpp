     ...
     mCoef_(NULL)
{
   ...
   {
      muInvCoef_ = new FunctionCoefficient(muInv);
   }
...
TeslaSolver::Solve()
{
   ...
   *RHS = 0.0;
   ...
   if ( j_ )
   {
      ...
      HypreParMatrix *Mass = hCurlMass_->ParallelAssemble();
   ...
   if ( m_ )
   {
      ...
      HypreParMatrix *Mass = hDivMassMuInv_->ParallelAssemble();
      HypreParVector *M    = m_->ParallelProject();
