...
public:
   ...
   /// @brief Delete all operators from the sequence.
   virtual ~MeshOperatorSequence();

   /** @brief Add an operator to the end of the sequence. The MeshOperatorSequence
       assumes ownership of the operator. */
   ...
   /// @brief Reset all MeshOperators in the sequence.
   virtual void Reset();
};
...
public:
   /** @brief Construct a ThresholdRefiner using the given ErrorEstimator. */
   ...
   /// @brief Get the number of marked elements in the last Apply() call.
   long GetNumMarkedElements() const { return num_marked_elements; }

   /// @brief Get the threshold used in the last Apply() call.
...
public:
   /** @brief Construct a ThresholdDerefiner using the given ErrorEstimator. */
