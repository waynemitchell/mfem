...
int main(int argc, char *argv[])
{
   ...
   adios2stream adios2output("refined.mesh.solution.bp", adios2stream::openmode::out, MPI_COMM_WORLD, "BPFile");
   ...
   adios2output.SetParameter("substreams", std::to_string(num_procs/procs2FilesRatio ));
