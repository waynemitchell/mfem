...
public:
     ...
     * with an optional integer index of the form abc[_b_c][_i]
     * e.g. density_001, position or volume_fraction
     ...
     *             and arr_idx will be 0,
     */
    static std::string DecomposeFieldName(const std::string& inputFldName, int& arr_idx);
