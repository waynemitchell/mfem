...
MFEM_REQ_LIB_DEPS = SUPERLU METIS CONDUIT SIDRE LAPACK SUNDIALS MESQUITE\
 SUITESPARSE STRUMPACK GECKO GNUTLS NETCDF PETSC MPFR PUMI OCCA ACROTENSOR
...
MFEM_DEFINES = MFEM_VERSION MFEM_VERSION_STRING MFEM_GIT_STRING MFEM_USE_MPI\
 ...
 MFEM_USE_MPFR MFEM_USE_SIDRE MFEM_USE_CONDUIT MFEM_USE_PUMI MFEM_USE_BACKENDS\
 MFEM_USE_OCCA MFEM_USE_ACROTENSOR MFEM_SOURCE_DIR MFEM_INSTALL_DIR
...
ALL_SRC_DIRS := general linalg mesh fem backends/base backends/occa backends/hypre
DIRS := $(ALL_SRC_DIRS)
